...
app.use((req, res, next) => {
  res.setHeader('Referrer-Policy', 'no-referrer-when-downgrade'); // Or 'unsafe-url' for full URL
  res.setHeader('Access-Control-Allow-Origin', 'https://vermillion-zuccutto-56a97a.netlify.app');
